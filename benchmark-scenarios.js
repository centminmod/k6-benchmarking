...
// taskset -c 0-3 k6 run -e RPS=${REQRATE} -e DURATION=${TIME}s -e USERS=${VU} -e STAGETIME=${TIME}s -e URL=$DOMAIN --no-usage-report --out json=summary-raw-scenarios.gz benchmark-scenarios.js
//
// scenario 2
// VU=50; TIME=30; REQUESTS=100; DOMAIN=https://yourdomain.com/
// taskset -c 0-3 k6 run -e REQUESTS=${REQUESTS} -e DURATION=${TIME}s -e USERS=${VU} -e STAGETIME=${TIME}s -e URL=$DOMAIN --no-usage-report --out json=summary-raw-scenarios.gz benchmark-scenarios.js
//
// scenario 3
// VU=50; TIME=30; DOMAIN=https://yourdomain.com/
// taskset -c 0-3 k6 run -e DURATION=${TIME}s -e USERS=${VU} -e STAGETIME=${TIME}s -e URL=$DOMAIN --no-usage-report --out json=summary-raw-scenarios.gz benchmark-scenarios.js
//
// scenario 4
